...
This ``homework" is meant to expose you to the Rnw format and to make sure you have set up Git, Github, R, and RStudio correctly. It will be submitted but not graded. 
